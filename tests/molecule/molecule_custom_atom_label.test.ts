...
// TODO(wasm): Canonizer with encodeAtomCustomLabels emits an extra byte in the
// idcode under WasmGC (a custom-label encoding difference), so the fromIDCode
// roundtrip of unicode custom labels does not match. Skipped until investigated.
test.skip('Custom atom labels should support unicode', () => {

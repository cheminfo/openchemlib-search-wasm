...
test('should allow to set random seed', () => {
...
test('should create smarts warnings', () => {
...
test('should parse into the passed molecule', () => {
  const parser = new SmilesParser();
  const molecule = new Molecule(0, 0);
...
test('should should optionally not invent coordinates', () => {
  const parser = new SmilesParser();
  const molecule = new Molecule(0, 0);
...
test('should should optionally not parse stereo features', () => {
  const parser = new SmilesParser();

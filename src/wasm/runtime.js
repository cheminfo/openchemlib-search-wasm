...
async function A(u, e, t, n) {
  ...
  const b =
    l > 0 ? new WebAssembly.Table({ initial: l, element: 'anyfunc' }) : null;
  u.env = { memory: f };
  u.teavmMemory = {
    linearMemory() {
      return f.buffer;
      ...
      async ({
        ...
        const a = await t({
          ...
          instantiateWasm(e, t) {
            ...
            e['GOT.mem'] = {
              __stack_low: new WebAssembly.Global(
                { value: 'i32', mutable: true },
                m,
              ),
  ...
  if (r === null) {
    r = (async () => {
      const e = new Int8Array([
        0, 97, 115, 109, 1, 0, 0, 0, 1, 7, 1, 96, 1, 127, 1, 100, 111, 2, 31, 1,
        14, 119, 97, 115, 109, 58, 106, 115, 45, 115, 116, 114, 105, 110, 103,
        12, 102, 114, 111, 109, 67, 104, 97, 114, 67, 111, 100, 101, 0, 0, 3, 1,
        0, 5, 4, 1, 1, 0, 0, 7, 10, 1, 6, 109, 101, 109, 111, 114, 121, 2, 0,
        10, -127, -128, -128, 0, 0,
      ]);
      try {
...
async function T(e, t, n, r) {
  ...
  if (
    typeof n.externalInfoPath === 'object' &&
    n.externalInfoPath instanceof Int8Array
  ) {
